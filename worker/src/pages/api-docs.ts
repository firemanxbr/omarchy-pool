  ...
  return [
    ...
    },
    {
      ...
      reads: [
        ...
        {
          path: "/api/v1/stats",
          fields: ["rings", "rings.0.ring", "rings.0.release", "coverage", "coverage.0.late", "late_after_hours", "pool.objects", "pool.bytes", "series.imports_daily", "series.health", "metrics", "events", "latest", "provenance", "any"],
        },
        {
