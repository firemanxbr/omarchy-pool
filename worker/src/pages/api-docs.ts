...
const BODY = String.raw`
  ...
  <section id="factory">
    ...
    <div class="table-wrap"><table><thead><tr><th>Endpoint</th><th>What it returns</th></tr></thead><tbody>
      ...
      <tr><td><code>GET /factory/approvals</code> · <code>/maintainers</code> · <code>/trust</code> · <code>/blocks</code></td><td>The record: every decision with who signed it and whether it stands (<code>standing</code>: approved, not withdrawn); the maintainers (from <code>factory/MAINTAINERS.toml</code>, with since when); project-trusted workers; what is blocked now and why.</td></tr>
