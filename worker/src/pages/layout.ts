...
const HELPERS = String.raw`
  ...
  function ask(o) {
    return new Promise(function (resolve) {
      ...
      var val = o.value !== undefined ? '<div class="val"><code></code><button type="button" class="copy">' + esc(o.copy || "Copy") + '</button></div>' : '';
      ...
      var cp = d.querySelector(".copy"); if (cp) cp.onclick = function () { navigator.clipboard.writeText(o.value).then(function () { cp.textContent = "Copied"; setTimeout(function () { cp.textContent = o.copy || "Copy"; }, 1500); }); };
