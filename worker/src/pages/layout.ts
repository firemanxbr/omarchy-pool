...
const CSS = String.raw`
  ...
  * { box-sizing: border-box; }
  ...
  .wtable td, .wtable th { white-space: nowrap; } .wtable .wid { font-size: 12px; } .wtable .pill { vertical-align: middle; } .wtable a.pill { text-decoration: none; }
